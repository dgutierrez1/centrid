...
const consoleMessages = new Map<string, Array<{ type: string; text: string; timestamp: number }>>();
const networkRequests = new Map<string, Array<{ url: string; method: string; status?: number; timestamp: number }>>();
