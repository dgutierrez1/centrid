...
### 0. Chat Interface (Full Integration)

**Purpose**: Complete chat interface demonstrating all components working together.

**Route**: `/thread/:threadId`

**Screenshots**:

- Desktop (1440×900): `apps/design-system/public/screenshots/ai-agent-system/chat-interface-desktop.png`
- Mobile (375×812): `apps/design-system/public/screenshots/ai-agent-system/chat-interface-mobile.png`

**Component Composition**:

- `BranchSelector` (header dropdown)
- `MessageStream` (message history with user/agent messages)
- `ContextPanel` (6 sections with horizontal widgets, positioned below messages, above input)
- `ThreadInput` (with @-mention autocomplete and send/stop toggle)

**Layout**: See [ux.md Chat Interface Layout](./ux.md#layout--spatial-design) for ASCII diagrams and spatial relationships

**States Shown**:

- Messages with tool call references
- Context panel with sections expanded/collapsed
- Priority tier indicators on left borders
- Semantic matches with relevance scores and branch indicators

**UX Specification Reference**: See [ux.md lines 33-118](./ux.md) for complete flow
...
- Mobile (375×812): `apps/design-system/public/screenshots/ai-agent-system/workspace-mobile.png`
...
**Layout**: See [ux.md Workspace Layout](./ux.md#layout--spatial-design) for ASCII diagrams showing 3-panel adaptive behavior (desktop with/without file, mobile drawer)
...
- Mobile (375×812): `apps/design-system/public/screenshots/ai-agent-system/branch-selector-mobile.png`
...
- Mobile (375×812): `apps/design-system/public/screenshots/ai-agent-system/file-editor-mobile.png`
